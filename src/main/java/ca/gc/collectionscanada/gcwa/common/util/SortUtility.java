...
import ca.gc.collectionscanada.gcwa.domain.Department;
import ca.gc.collectionscanada.gcwa.domain.DepartmentWiseURLs;
import ca.gc.collectionscanada.gcwa.domain.SingleURL;
